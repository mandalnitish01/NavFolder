        ...
        <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
          <form>
            <div
              ...
              <p class="text-white mb-0 me-4 text-lg">Sign up with</p>
  
              <button
                type="button"
                data-twe-ripple-init
                data-twe-ripple-color="light"
                class=" mx-1 bg-blue-800 inline-block h-9 w-9 rounded-full bg-primary fill-white p-2 uppercase leading-normal shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong">
            ...
            <div
              class="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-100 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-100 dark:before:border-neutral-100 dark:after:border-neutral-100">
              <p
